...
class Depan extends Component {
    constructor(props){
        ...
        this.url = "http://192.168.0.107/api/api.php";
    }
        ...
        return (
            <View style={style.viewWrapper}>
                ...
                <View style={style.viewForm}>
                    <TextInput style={style.textInput} placeholder="Masukkan Nama" value={this.state.nama}
                        onChangeText={(text)=>this.setState({nama:text})}></TextInput>
                    <TextInput style={style.textInput} placeholder="Masukkan Alamat" value={this.state.alamat}
